...
<head>
    ...
    <title>Add Plan – SaaSSpace Admin</title>
    <style>
            ...
            <form action="{{ route('admin.pricing.store') }}" method="POST">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Starter, Pro, Enterprise" required>
                    </div>
                    <div class="form-group">
                        <label>Price (USD) *</label>
                        <input type="number" name="price" value="{{ old('price') }}" placeholder="e.g. 999" min="0" step="0.01" required>
                    </div>
                    <div class="form-group">
                        <label>Billing Period</label>
                        <input type="text" name="billing_period" value="{{ old('billing_period', 'month') }}" placeholder="month / project / year">
                    </div>
                    <div class="form-group">
                        <label>Button Text</label>
                        <input type="text" name="btn_text" value="{{ old('btn_text', 'Get Started') }}" required>
                    </div>
                    <div class="form-group full">
                        <label>Button URL</label>
                        <input type="text" name="btn_url" value="{{ old('btn_url') }}" placeholder="https://calendly.com/..." required>
                    </div>
                    <div class="form-group full">
                        <label>Features (one per line) *</label>
                        <textarea name="features" placeholder="Unlimited Revisions&#10;Dedicated Designer&#10;Weekly Updates">{{ old('features') }}</textarea>
                        <span class="help-text">Each line = one feature bullet point</span>
                    </div>
                    <div class="form-group">
