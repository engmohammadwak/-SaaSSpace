...
<head>
    ...
    <title>Edit Project – SaaSSpace Admin</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .current-img { max-width: 100%; max-height: 200px; border-radius: 8px; object-fit: cover; margin-bottom: 6px; }
            ...
            <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        @if($project->image)
                        <img src="{{ Storage::url($project->image) }}" alt="current" class="current-img">
                    ...
                    <div class="form-group">
                        <div class="toggle-row">
                            <input type="checkbox" name="is_active" id="is_active" {{ $project->is_active ? 'checked' : '' }}>
