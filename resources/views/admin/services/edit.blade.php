...
<head>
    ...
    <title>Edit Service – SaaSSpace Admin</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .current-icon { width: 56px; height: 56px; border-radius: 8px; object-fit: contain; background: #1a1a1a; padding: 4px; }
        .current-label { font-size: 11px; color: #555; margin-top: 3px; }
    </style>
</head>
<body>
            ...
            <form action="{{ route('admin.services.update', $service) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label>Icon Image (leave empty to keep current)</label>
                        @if($service->icon)
                        <img src="{{ Storage::url($service->icon) }}" alt="current" class="current-icon">
                        <p class="current-label">Current icon ↑</p>
                        @endif
